...
var BasicComponent = /** @class */ (function () {
    ...
    BasicComponent.prototype.getMsg = function () {
        alert(this.msg + this.numberValue);
        this.addValue();
    };
    BasicComponent.prototype.addValue = function () {
        this.numberValue++;
    };
    BasicComponent.prototype.keyupFn = function (e) {
    ...
    BasicComponent.prototype.run = function (e) {
        console.log(e);
    };
...
var CartComponent = /** @class */ (function () {
    ...
    CartComponent.prototype.run = function () {
        alert("cart method");
    };
...
var DemoTodoListComponent = /** @class */ (function () {
    /* 推荐注入方式 */
    function DemoTodoListComponent(storage) {
    ...
    DemoTodoListComponent.prototype.ngOnInit = function () {
    };
    DemoTodoListComponent.prototype.addData = function () {
        if (this.username === "") {
            return;
        }
        var obj = {
    ...
    DemoTodoListComponent.prototype.addEnter = function (e) {
        if (e.keyCode == 13) {
            var obj = {
                username: this.username,
                status: 1,
    ...
    DemoTodoListComponent.prototype.updateStatus = function (index, status) {
        this.items[index].status = status;
        var todoList = this.storage.getItem("todolist");
        todoList[index].status = status;
        this.storage.setItem("todolist", todoList);
    };
    DemoTodoListComponent.prototype.deleteData = function (index) {
        this.items.splice(index, 1);
    };
    DemoTodoListComponent.ctorParameters = function () { return [
...
var FooterComponent = /** @class */ (function () {
    ...
    FooterComponent.prototype.sendParent = function () {
...
var PageAComponent = /** @class */ (function () {
    function PageAComponent() {
    }
    PageAComponent.prototype.ngOnInit = function () {
    };
...
var PageBComponent = /** @class */ (function () {
...
var PageCComponent = /** @class */ (function () {
    function PageCComponent(route) {
        this.route = route;
    }
    PageCComponent.prototype.ngOnInit = function () {
        console.log(this.route.params['value']['id']);
        this.route.params.subscribe(function (data) {
            console.log(data.id);
        });
    };
    PageCComponent.ctorParameters = function () { return [
...
var PanleAComponent = /** @class */ (function () {
    function PanleAComponent() {
        this.title = "This is panle a title";
        this.name = "This is panle a name";
    }
    PanleAComponent.prototype.ngOnInit = function () {
    };
    PanleAComponent.prototype.run = function () {
        alert("panel a alert");
    };
    PanleAComponent.prototype.getDataFromChild = function (childData) {
        this.name = childData;
        alert(childData);
    };
...
var PanleBComponent = /** @class */ (function () {
    function PanleBComponent(http) {
        this.http = http;
        this.title = "This is panle b title";
        this.name = "This is panle b name";
    }
    PanleBComponent.prototype.ngOnInit = function () {
    };
    PanleBComponent.prototype.requestData = function (e) {
        console.log(e);
        var _that = this;
    ...
    PanleBComponent.ctorParameters = function () { return [
...
var PanleCComponent = /** @class */ (function () {
    function PanleCComponent() {
        //EventEmitter实现子组件传值给父组件
        this.toparent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    PanleCComponent.prototype.ngOnInit = function () {
    };
    PanleCComponent.prototype.requestData = function () {
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.getCartData = function () {
        alert(this.cart.msg);
        alert(this.cart.name);
    };
    ProductComponent.prototype.updateNameFromCart = function () {
        this.productName = this.cart.name;
    };
    ProductComponent.prototype.executeCartMethod = function () {
        this.cart.run();
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var RequestFromServerComponent = /** @class */ (function () {
    function RequestFromServerComponent(http) {
        this.http = http;
    }
    RequestFromServerComponent.prototype.ngOnInit = function () {
    };
    RequestFromServerComponent.prototype.requestData = function () {
        var _that = this;
        var url = "http://word.xushikuan.com/words";
        this.http.get(url).subscribe(function (data) {
            console.log(data);
    ...
    RequestFromServerComponent.prototype.requestDataRXJS = function () {
        var _that = this;
        var url = "http://word.xushikuan.com/words";
        var apiData = Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_3__["ajax"])(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), // Retry up to 3 times before failing
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            if (!res.response) {
                throw new Error('Value expected!');
            }
            return res.response;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])([]); }));
        apiData.subscribe({
            next: function (data) {
                console.log(data);
    ...
    //后端不允许跨域，可以用这种方式
    RequestFromServerComponent.prototype.requestJsonpData = function () {
        var _that = this;
    ...
    RequestFromServerComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return RequestFromServerComponent;
}());
